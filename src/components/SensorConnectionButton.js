...
import { COLORS, FONTS, SIZES, SHADOWS, SPACE } from '../constants/theme';
import GlassCard from './GlassCard';

export default function SensorConnectionButton({ isConnected, isScanning, onConnect, onDisconnect }) {
