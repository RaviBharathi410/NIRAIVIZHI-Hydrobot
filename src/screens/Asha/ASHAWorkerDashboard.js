...
export default function ASHAWorkerDashboard({ navigation }) {
    const { t } = useLanguage();
    ...
    const ACTIONS = [
        { title: t('waterTest'), icon: 'test-tube', color: COLORS.info, bg: COLORS.iconBlueBg, screen: 'WaterTestForm' },
        { title: t('patientVisits'), icon: 'account-plus-outline', color: COLORS.success, bg: COLORS.iconGreenBg, screen: 'PatientVisitsList' },
        { title: t('symptomTrends'), icon: 'chart-bell-curve', color: COLORS.warning, bg: COLORS.iconOrangeBg, screen: 'SymptomTrends' },
        { title: t('generateReport'), icon: 'file-export-outline', color: COLORS.primary, bg: COLORS.iconPurpleBg, screen: 'GenerateReport' },
    ];
...
const styles = StyleSheet.create({
    ...
    profileBtn: { ...SHADOWS.glow(COLORS.primary, 15, 0.3) },
