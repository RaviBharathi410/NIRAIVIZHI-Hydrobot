        ...
        <View style={styles.container}>
            ...
            <View style={styles.cameraView}>
                ...
                <MotiView
                    ...
                    transition={{ loop: true, duration: 4000, type: 'timing' } as any}
                ...
                {objects.slice(0, 10).map((obj, i) => (
                    ...
                    >
                        ...
                        <MotiView
                            from={{ opacity: 0.2 }}
                            animate={{ opacity: 0.5 }}
                            transition={{ loop: true, duration: 1000 } as any}
...
const styles = StyleSheet.create({
    ...
    labelText: { ...FONTS.bold, fontSize: 10, color: COLORS.text },
    ...
    title: { ...FONTS.extraBold, fontSize: 32, color: COLORS.text, marginBottom: 8, letterSpacing: 1 },
    ...
    metricVal: { ...FONTS.bold, fontSize: 16, color: COLORS.text },
