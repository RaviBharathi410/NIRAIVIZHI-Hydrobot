...
const styles = StyleSheet.create({
    ...
    gVal: { ...FONTS.bold, fontSize: 18, color: COLORS.text },
    ...
    fVal: { ...FONTS.bold, fontSize: 13, color: COLORS.text, marginTop: 8 },
    evacuationCard: { marginTop: 10, padding: 20 },
    evacHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
    evacTitle: { ...FONTS.bold, fontSize: 16, color: COLORS.text, marginLeft: 12 },
