...
const styles = StyleSheet.create({
    ...
    gasLabel: { ...FONTS.bold, fontSize: 12, color: COLORS.text, marginTop: 15, textAlign: 'center' },
    ...
    secVal: { ...FONTS.bold, fontSize: 16, color: COLORS.text, marginTop: 8 },
    ...
    safetyTitle: { ...FONTS.bold, fontSize: 16, color: COLORS.text, marginLeft: 12 },
