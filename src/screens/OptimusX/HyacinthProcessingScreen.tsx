...
const styles = StyleSheet.create({
    ...
    pTitle: { ...FONTS.bold, fontSize: 20, color: COLORS.text },
    ...
    cVal: { ...FONTS.bold, fontSize: 16, color: COLORS.text, marginTop: 8 },
    ...
    logTitle: { ...FONTS.bold, fontSize: 16, color: COLORS.text },
    logSub: { ...FONTS.medium, fontSize: 12, color: COLORS.textSecondary, marginTop: 4 },
    logBtn: { marginTop: 16 },
    outputBox: { padding: 16 },
    outTitle: { ...FONTS.bold, fontSize: 16, color: COLORS.text, marginBottom: 16, textAlign: 'center' },
