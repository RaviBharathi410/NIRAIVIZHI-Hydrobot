...
export default function LiveTrashAnalyticsScreen() {
    const TRASH_DATA = [
        ...
        { label: 'Organic', value: 25, icon: 'leaf-outline', color: '#10B981' },
        { label: 'Metallic', value: 15, icon: 'can-outline', color: '#94A3B8' },
                    ...
                    {TRASH_DATA.map((item, i) => (
                        ...
                        >
                            <GlassCard style={styles.trashCard}>
                                <IconBadge icon={item.icon} size={40} color={item.color} />
