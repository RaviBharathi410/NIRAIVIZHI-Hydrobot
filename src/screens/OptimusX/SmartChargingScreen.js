...
export default function SmartChargingScreen() {
    ...
    const [solarInput, setSolarInput] = useState(45);
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.sourceGrid}>
                    <GlassCard style={styles.sourceCard}>
                        <IconBadge icon="solar-power-variant-outline" size={40} color={COLORS.warning} />
                ...
                <View style={styles.summaryCard}>
                    ...
                    <View style={styles.ecoRow}>
                        ...
                        <Text style={styles.ecoText}>14.2 kg CO₂ Offset this month</Text>
                    </View>
                </View>
            </ScrollView>
        </View>
...
const styles = StyleSheet.create({
    ...
    pVal: { ...FONTS.bold, fontSize: 16, color: COLORS.white },
    ...
    sVal: { ...FONTS.bold, fontSize: 18, color: COLORS.white, marginTop: 10 },
    sLabel: { ...FONTS.medium, fontSize: 12, color: COLORS.textSecondary },
    summaryCard: { marginTop: 10, padding: 16 },
    summaryTitle: { ...FONTS.bold, fontSize: 16, color: COLORS.white, marginBottom: 8 },
