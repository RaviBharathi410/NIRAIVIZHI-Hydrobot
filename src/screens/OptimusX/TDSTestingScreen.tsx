...
const styles = StyleSheet.create({
    ...
    infoValue: { ...FONTS.bold, fontSize: 16, color: COLORS.text, marginTop: 4 },
    sectionTitle: { ...FONTS.bold, fontSize: 18, color: COLORS.text, marginBottom: 16 },
    refRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 16 },
    refBar: { width: 6, height: 34, borderRadius: 3, marginRight: 16 },
    refInfo: { flex: 1 },
    refRange: { ...FONTS.bold, fontSize: 14, color: COLORS.text },
