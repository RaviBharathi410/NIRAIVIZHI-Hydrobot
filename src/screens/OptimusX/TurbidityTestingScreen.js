...
export default function TurbidityTestingScreen() {
    ...
    const turbidity = sensorData ? parseFloat(sensorData.turbidity) : 0;
                        ...
                        <MotiView from={{ opacity: 0, scale: 0.9 }} animate={{ opacity: 1, scale: 1 }}>
                            ...
                            <GlassCard>
                                ...
                                <View style={styles.thresholdRow}>
                                    ...
                                    <View style={styles.tItem}>
                                        <Text style={[styles.tVal, { color: COLORS.warning }]}>10-25</Text>
                                        <Text style={styles.tLabel}>Alert</Text>
                                    </View>
                                    <View style={styles.tItem}>
