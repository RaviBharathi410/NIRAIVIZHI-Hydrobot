...
import { COLORS, FONTS, GRADIENTS, SPRING, SHADOWS } from '../../constants/theme';
    ...
    return (
        <View style={styles.container}>
            ...
            <MotiView
                ...
                transition={{ type: 'spring', ...(SPRING.bouncy as any) } as any}
                style={styles.content}
            >
                <LinearGradient colors={GRADIENTS.primary as any} style={styles.iconCircle}>
                ...
                <View style={styles.loader}>
                    <MotiView
                        from={{ scaleX: 0 }}
                        animate={{ scaleX: 1 }}
                        transition={{ duration: 2000, type: 'timing' } as any}
...
const styles = StyleSheet.create({
    ...
    iconCircle: { width: 100, height: 100, borderRadius: 50, justifyContent: 'center', alignItems: 'center', marginBottom: 30, ...(SHADOWS.glow(COLORS.primary, 20, 0.3) as any) },
    ...
    loader: { width: 200, height: 4, backgroundColor: COLORS.border as string, borderRadius: 2, marginTop: 40, overflow: 'hidden' },
